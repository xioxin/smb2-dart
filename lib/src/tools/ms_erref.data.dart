part of 'ms_erref.dart';

const code = 'code';
const message = 'message';

const Map<int, Map<String, String>> severities = {
  0: {
...
const Map<int, Map<String, String>> facilities = {
  0: {
    code: 'FACILITY_NULL',
...
const Map<String, Map<String, String>> ntStatus = {
  '0x00000000': {
    'code': 'STATUS_SUCCESS',
...
const Map<String, Map<String, String>> win32ErrorCodes = {
  '0x00000000': {
    'code': 'ERROR_SUCCESS',
    'message': 'The operation completed successfully.',
  },
